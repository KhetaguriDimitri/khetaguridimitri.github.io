(function(e) {
	...
	"0a49": function(e, t, n) {
		...
		e.exports = function(e, t) {
			...
			return function(t, c, h) {
				for (var _, m, v = i(t), y = o(v), g = r(c, h, 3), b = a(y.length), w = 0, x = n ? d(t, b) : s ? d(t, 0) : void 0; b > w; w++)
					if ((f || w in y) && (_ = y[w], m = g(_, w, v), e))
						if (n) x[w] = m;
						else if (m) switch (e) {
					case 3:
						return !0;
	...
	"28a5": function(e, t, n) {
		...
		n("214f")("split", 2, function(e, t, n, l) {
			var y;
			return y = "c" == "abbc" [d](/(b)*/)[1] || 4 != "test" [d](/(?:)/, -1)[h] || 2 != "ab" [d](/(?:ab)*/)[h] || 4 != "." [d](/(.?)(.?)/)[h] || "." [d](/()()/)[h] > 1 || "" [d](/.?/)[h] ? function(e, t) {
				var o = String(this);
				...
				while (i = u.call(v, o)) {
					if (a = v[_], a > p && (s.push(o.slice(p, i.index)), i[h] > 1 && i.index < o[h] && f.apply(s, i.slice(1)), c = i[0][h], p = a, s[h] >= d)) break;
					v[_] === i.index && v[_]++
				}
				return p === o[h] ? !c && v.test("") || s.push("") : s.push(o.slice(p)), s[h] > d ? s.slice(0, d) : s
				...
				var u = o(e),
					...
					d = i(u, RegExp),
					h = u.unicode,
					_ = (u.ignoreCase ? "i" : "") + (u.multiline ? "m" : "") + (u.unicode ? "u" : "") + (v ? "y" : "g"),
					g = new d(v ? u : "^(?:" + u.source + ")", _),
					b = void 0 === t ? m : t >>> 0;
				if (0 === b) return [];
				...
				while (x < f.length) {
					g.lastIndex = v ? x : 0;
					var k, S = s(g, v ? f : f.slice(x));
					if (null === S || (k = p(c(g.lastIndex + (v ? 0 : x)), f.length)) === w) x = a(f, x, h);
					else {
						if (C.push(f.slice(w, x)), C.length === b) return C;
						for (var P = 1; P <= S.length - 1; P++)
							if (C.push(S[P]), C.length === b) return C;
						x = w = k
					}
				}
	...
	"2b0e": function(e, t, n) {
		...
		(function(e) {
			...
			function Be(e, t, n) {
				if ("function" === typeof t && (t = t.options), He(t, n), Ue(t, n), ze(t), !t._base && (t.extends && (e = Be(e, t.extends, n)), t.mixins))
			...
			var sn = 0,
				un = function(e, t, n, r, o) {
					this.vm = e, o && (e._watcher = this), e._watchers.push(this), r ? (this.deep = !!r.deep, this.user = !!r.user, this.lazy = !!r.lazy, this.sync = !!r.sync, this.before = r.before) : this.deep = this.user = this.lazy = this.sync = !1, this.cb = n, this.id = ++sn, this.active = !0, this.dirty = this.lazy, this.deps = [], this.newDeps = [], this.depIds = new se, this.newDepIds = new se, this.expression = "", "function" === typeof t ? this.getter = t : (this.getter = G(t), this.getter || (this.getter = E)), this.value = this.lazy ? void 0 : this.get()
				};
			...
			function er(e, t, n, r, i) {
				...
				(Array.isArray(r) && "function" === typeof r[0] && (n = n || {}, n.scopedSlots = {
					default: r[0]
				}, r.length = 0), i === Zn ? r = xt(r) : i === Yn && (r = wt(r)), "string" === typeof t) ? (c = e.$vnode && e.$vnode.ns || H.getTagNamespace(t), a = H.isReservedTag(t) ? new me(H.parsePlatformTagName(t), n, r, void 0, void 0, e) : n && n.pre || !o(s = Ge(e.$options, "components", t)) ? new me(t, n, r, void 0, void 0, e) : Wn(s, n, e, r, t)) : a = Wn(t, n, e, r);
			...
			function ar(e) {
				e.prototype._init = function(e) {
					var t = this;
					t._uid = ir++, t._isVue = !0, e && e._isComponent ? cr(t, e) : t.$options = Be(sr(t.constructor), e || {}, t), t._renderProxy = t, t._self = t, Ht(t), Tt(t), rr(t), qt(t, "beforeCreate"), Pn(t), fn(t), Sn(t), qt(t, "created"), t.$options.el && t.$mount(t.$options.el)
				}
			}
			...
			function sr(e) {
				...
				if (e.super) {
					...
					if (n !== r) {
						e.superOptions = n;
						var o = ur(e);
						o && T(e.extendOptions, o), t = e.options = Be(n, e.extendOptions), t.name && (t.components[t.name] = e)
					}
				}
				return t
			}
			...
			function hr(e) {
				...
				e.extend = function(e) {
					...
					return a.prototype = Object.create(n.prototype), a.prototype.constructor = a, a.cid = t++, a.options = Be(n.options, e), a["super"] = n, a.options.props && _r(a), a.options.computed && mr(a), a.extend = n.extend, a.mixin = n.mixin, a.use = n.use, R.forEach(function(e) {
						a[e] = n[e]
			...
			function Sr(e) {
				...
				Object.defineProperty(e, "config", t), e.util = {
					...
					mergeOptions: Be,
					defineReactive: je
				}, e.set = Ee, e.delete = Me, e.nextTick = lt, e.options = Object.create(null), R.forEach(function(t) {
			...
			function Rr(e) {
				return Array.isArray(e) ? Vr(e) : s(e) ? Hr(e) : "string" === typeof e ? e : ""
			}
			...
			function Co(e, t) {
				...
				if (!e) return o;
				for (n = 0; n < e.length; n++) r = e[n], r.modifiers || (r.modifiers = xo), o[ko(r)] = r, r.def = Ge(t.$options, "directives", r.name, !0);
				return o
			}
			...
			function Vo(e, t) {
				if (!r(e.data.on) || !r(t.data.on)) {
					var n = t.data.on || {},
						o = e.data.on || {};
					Eo = t.elm, Lo(n), vt(n, o, No, Ro, Fo, t.context), Eo = void 0
				}
			}
			var Ho = {
				create: Vo,
			...
			function zo(e, t) {
				return !e.composing && ("OPTION" === e.tagName || Bo(e, t) || Go(e, t))
			}
					...
					if (!A || w || "" === w) {
						...
						var L = !1 !== a && !Q,
							...
							R = n._enterCb = F(function() {
								L && (bi(n, T), bi(n, $)), R.cancelled ? (L && bi(n, O), D && D(n)) : M && M(n), n._enterCb = null
							});
						e.data.show || yt(e, "insert", function() {
							...
							bi(n, O), R.cancelled || (gi(n, T), N || (Oi(I) ? setTimeout(R, I) : wi(n, c, R)))
						})), e.data.show && (t && t(), E && E(n, R)), L || N || R()
					}
				}
			}
			...
			var Ii = {
				inserted: function(e, t, n, r) {
					...
					}) : Li(e, t, n.context), e._vOptions = [].map.call(e.options, Ri)) : ("textarea" === n.tag || Xr(e.type)) && (e._vModifiers = t.modifiers, t.modifiers.lazy || (e.addEventListener("compositionstart", Vi), e.addEventListener("compositionend", Hi), e.addEventListener("change", Hi), Q && (e.vmodel = !0)))
				},
			...
			function Fi(e, t, n) {
				...
				if (!o || Array.isArray(r)) {
					for (var i, a, c = 0, s = e.options.length; c < s; c++)
						...
						else if (I(Ri(a), r)) return void(e.selectedIndex !== c && (e.selectedIndex = c));
					o || (e.selectedIndex = -1)
				}
			}
			...
			pr.config.mustUseProp = Or, pr.config.isReservedTag = Gr, pr.config.isReservedAttr = Pr, pr.config.getTagNamespace = Wr, pr.config.isUnknownElement = qr, T(pr.options.directives, Gi), T(pr.options.components, aa), pr.prototype.__patch__ = q ? Di : E, pr.prototype.$mount = function(e, t) {
	...
	d256: function(e, t, n) {
		...
		var r = n("da3c"),
			...
			q = function(e, t, n) {
				return e === H && q(V, t, n), y(e), t = w(t, !0), y(n), o(R, t) ? (n.enumerable ? (o(e, I) && e[I][t] && (e[I][t] = !1), n = C(n, {
					enumerable: x(0, !1)
				})) : (o(e, I) || $(e, I, x(1, {})), e[I][t] = !0), G(e, t, n)) : $(e, t, n)
			},
			X = function(e, t) {
				y(e);
				var n, r = m(t = b(t)),
			...
			Y = function(e) {
				...
				return !(this === H && o(R, e) && !o(V, e)) && (!(t || !o(this, e) || !o(R, e) || o(this, I) && this[I][e]) || t)
			},
			Z = function(e, t) {
				if (e = b(e), t = w(t, !0), e !== H || !o(R, t) || o(V, t)) {
					var n = O(e, t);
					return !n || !o(R, t) || o(e, I) && e[I][t] || (n.enumerable = !0), n
				}
			},
			Q = function(e) {
				var t, n = T(b(e)),
					r = [],
					i = 0;
				while (n.length > i) o(R, t = n[i++]) || t == I || t == s || r.push(t);
				return r
			},
			ee = function(e) {
				var t, n = e === H,
		...
		U || (j = function() {
			...
			var e = f(arguments.length > 0 ? arguments[0] : void 0),
				t = function(n) {
					this === H && t.call(V, n), o(this, I) && o(this[I], e) && (this[I][e] = !1), G(this, e, x(1, n))
				};
			return i && B && G(H, e, {
				configurable: !0,
				set: t
	...
	da68: function(e, t, n) {
		...
		var r = function() {
			...
			_ = {
				...
				methods: {
					currencyChanged: function(e) {
						Object(p["a"])(this.$el).setAttribute("currency", e.target.value.toLowerCase())
					},
					formatCurrency: function(e) {
						return Object(f["formatCurrency"])(e, this.currencyCode, this.locale)
					},
					...
					linkToCoinOverview: function(e) {
						return "https://www.coingecko.com/resource_redirect?locale=".concat(this.locale, "&route=coins/").concat(e, "&").concat(this.utmParams(e))
					},
			...
			m = _,
			v = n("2877"),
			y = Object(v["a"])(m, r, o, !1, null, null, null);
		y.options.__file = "CoingeckoCoinPriceMarqueeWidget.vue";
		t["a"] = y.exports
	},
	dcbc: function(e, t, n) {
		var r = n("2aba");
